...
<body>
<form action="https://irooom.herokuapp.com/includes/logged.php" method="post">
      ...
      <input type="submit" name="submit" value="Log in" class="w3-btn w3-section w3-center"></input>
